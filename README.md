...
| `extensions`          | `Extension[]`               | A list of extensions to use for the editor.                                                                                                                                         | [`default Novel extensions``](https://github.com/steven-tey/novel/blob/main/packages/core/src/ui/editor/extensions/index.tsx)       |
